...
**时间**: 2026-06-09 20:06 (Asia/Shanghai) / 周二晚间
...
| OpenClaw Gateway | 🟢 | port 18789 ✅ running, uptime 1d 10h |
...
| Job | 状态 | 上次运行 | 下次运行 |
|-----|------|----------|----------|
| `team-deep-check` (每4h) | 🟡 |2026-06-09 16:03 ⚠️ **error (overload)** | 2026-06-09 20:03 → 已触发本次 |
| `team-coordinator-hourly` | 🟢 | 2026-06-09 20:04 ✅ | 2026-06-09 21:04 |

> ⚠️ **`team-deep-check` 本次（16:03）收到 "AI service temporarily overloaded" 错误一次**，consecutiveErrors: 1。已恢复，无持续性影响。本次 20:06 深度检查正常触发。
...
🎊 **鸠摩罗什Bot 7x24 持续健康运行中，所有关键链路绿色。下次检查: 2026-06-10 00:04**

---

*team-deep-check - 2026-06-09 20:06 (Asia/Shanghai)*